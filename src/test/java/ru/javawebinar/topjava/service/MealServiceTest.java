...
import ru.javawebinar.topjava.rules.TestTimeCollectorRule;
import ru.javawebinar.topjava.rules.TestTimeRule;
...
public class MealServiceTest {
    ...
    @Rule
    public TestTimeRule testTimeRule = new TestTimeRule(testExecutionTimeCollector);
